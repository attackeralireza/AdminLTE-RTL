  ...
  var t = (function (e) {
      var t = "ControlSidebar",
        ...
        E = (function () {
          ...
          return (
              ...
              this._config.controlsidebarSlide
                ? (e("html").addClass(h),
                  e("body")
                    ...
                    .delay(300)
                    .queue(function () {
                      e(o).hide(), e("html").removeClass(h), e(this).dequeue();
                    }))
                  ...
                  e(o)
                    ...
                    .queue(function () {
                      e("body")
                        ...
                        .delay(300)
                        .queue(function () {
                          e("html").removeClass(h), e(this).dequeue();
                        }),
                        e(this).dequeue();
                    }))
                : e("body").addClass(d);
            ...
            (i.toggle = function () {
              e("body").hasClass(d) || e("body").hasClass(u)
                ? this.show()
                : this.collapse();
            }),
            (i._init = function () {
            ...
            (i._fixScrollHeight = function () {
              ...
              e("body").hasClass(f) &&
                ...
                (e("body").hasClass(C) ||
                  ...
                  e("body").hasClass(D) ||
                  e("body").hasClass(A)) &&
                  "fixed" === e(c).css("position") &&
                  (r = !0),
                0 === i && 0 === n
                  ? (e(o).css("bottom", t.footer),
                    e(o).css("top", t.header),
                    e(o + ", " + o + " " + a).css(
                      "height",
                      t.window - (t.header + t.footer)
                    ))
                  : n <= t.footer
                  ? !1 === r
                    ? (e(o).css("bottom", t.footer - n),
                      e(o + ", " + o + " " + a).css(
                        "height",
                        t.window - (t.footer - n)
                      ))
            ...
            (i._fixHeight = function () {
              ...
              if (e("body").hasClass(f)) {
                ...
                (e("body").hasClass(C) ||
                  ...
                  (s = t - n - i),
                  e(o + " " + a).css("height", s),
                  "undefined" != typeof e.fn.overlayScrollbars &&
                    e(o + " " + a).overlayScrollbars({
            ...
            (t._jQueryInterface = function (i) {
              return this.each(function () {
                var s = e(this).data(n);
                if (
                  (s || ((s = new t(this, e(this).data())), e(this).data(n, s)),
                  "undefined" === s[i])
                )
      ...
      return (
        e(document).on("click", r, function (t) {
          t.preventDefault(), E._jQueryInterface.call(e(this), "toggle");
        }),
        (e.fn[t] = E._jQueryInterface),
        (e.fn[t].Constructor = E),
        (e.fn[t].noConflict = function () {
          return (e.fn[t] = i), E._jQueryInterface;
        }),
        E
      );
    })(jQuery),
    n = (function (e) {
      var t = "Layout",
        ...
        c = "sidebar-focused",
        h = "layout-fixed",
        d = { scrollbarTheme: "os-theme-light", scrollbarAutoHide: "l" },
        u = (function () {
          function t(e, t) {
          ...
          return (
            (n.fixLayoutHeight = function () {
              var t = {
                ...
                n = this._max(t);
              e("body").hasClass(h)
                ? (e(a).css("min-height", n - t.header - t.footer),
                  "undefined" != typeof e.fn.overlayScrollbars &&
                    e(o).overlayScrollbars({
                      className: this._config.scrollbarTheme,
                      sizeAutoCapable: !0,
                      scrollbars: {
                        autoHide: this._config.scrollbarAutoHide,
                ...
                : t.window > t.sidebar
                ? e(a).css("min-height", t.window - t.header - t.footer)
                : e(a).css("min-height", t.sidebar - t.header);
            }),
            (n._init = function () {
              var t = this;
            ...
            (t._jQueryInterface = function (n) {
              return this.each(function () {
                ...
                i || ((i = new t(e(this), s)), e(this).data("lte.layout", i)),
                  "init" === n && i[n]();
              });
            }),
            t
    ...
    i = (function (e) {
      var t = "PushMenu",
        n = ".lte.pushmenu",
        i = e.fn[t],
        s = { COLLAPSED: "collapsed" + n, SHOWN: "shown" + n },
        o = {
          autoCollapseSize: !1,
          ...
          return (
            (i.show = function () {
              e(a.BODY).addClass(l).removeClass(r),
                this._options.enableRemember &&
                  localStorage.setItem("remember" + n, l);
            ...
            (i.collapse = function () {
              e(a.BODY).removeClass(l).addClass(r),
                this._options.enableRemember &&
                  localStorage.setItem("remember" + n, r);
              var t = e.Event(s.COLLAPSED);
              e(this._element).trigger(t);
            }),
            (i.isShown = function () {
              return e(window).width() >= this._options.screenCollapseSize
                ? !e(a.BODY).hasClass(r)
                : e(a.BODY).hasClass(l);
            }),
            (i.toggle = function () {
            ...
            (i.autoCollapse = function () {
              this._options.autoCollapseSize &&
                (e(window).width() <= this._options.autoCollapseSize
                  ? this.isShown() && this.toggle()
                  : this.isShown() || this.toggle());
            }),
            (i.remember = function () {
              this._options.enableRemember &&
                localStorage.getItem("remember" + n) == r &&
            ...
            (t._jQueryInterface = function (n) {
              return this.each(function () {
                ...
                i || ((i = new t(this, s)), e(this).data("lte.pushmenu", i)),
                  "toggle" === n && i[n]();
              });
            }),
            t
      ...
      return (
        e(document).on("click", a.TOGGLE_BUTTON, function (t) {
          t.preventDefault();
          var n = t.currentTarget;
          "pushmenu" !== e(n).data("widget") &&
            (n = e(n).closest(a.TOGGLE_BUTTON)),
          ...
          return (
            ...
            (n.expand = function (t, n) {
              ...
              t.stop().slideDown(this._config.animationSpeed, function () {
                n.addClass(l), e(s._element).trigger(r);
              });
            }),
            ...
            (t._jQueryInterface = function (n) {
              return this.each(function () {
                ...
                i || ((i = new t(e(this), s)), e(this).data("lte.treeview", i)),
                  "init" === n && i[n]();
              });
            }),
            t
    ...
    o = (function (e) {
          ...
          return (
            ...
            (t._jQueryInterface = function (n) {
              return this.each(function () {
                ...
                i || ((i = new t(e(this))), e(this).data("lte.directchat", i)),
                  i[n]();
              });
            }),
            t
      ...
      return (
        e(document).on("click", s, function (t) {
          t && t.preventDefault(), r._jQueryInterface.call(e(this), "toggle");
        }),
        (e.fn[t] = r._jQueryInterface),
        (e.fn[t].Constructor = r),
        (e.fn[t].noConflict = function () {
          return (e.fn[t] = n), r._jQueryInterface;
        }),
        r
      );
    })(jQuery),
            ...
            (t._jQueryInterface = function (n) {
              return this.each(function () {
                var i = e(this).data("lte.todolist"),
                  s = e.extend({}, o, e(this).data());
                i || ((i = new t(e(this), s)), e(this).data("lte.todolist", i)),
                  "init" === n && i[n]();
              });
            }),
            t
                ...
                this._parent
                  ...
                  .queue(function () {
                    e(this).addClass(o.MAXIMIZED),
                      ...
                      e(this).hasClass(o.COLLAPSED) &&
                        e(this).addClass(o.WAS_COLLAPSED),
                      e(this).dequeue();
                  });
                ...
                this._parent
                  ...
                  .queue(function () {
                    e(this).removeClass(o.MAXIMIZED),
                      ...
                      e(this).css({ height: "inherit", width: "inherit" }),
                      e(this).hasClass(o.WAS_COLLAPSED) &&
                        e(this).removeClass(o.WAS_COLLAPSED),
                      e(this).dequeue();
                  });
            ...
            (t._jQueryInterface = function (n) {
              ...
              i ||
                ...
                n.match(
                  ...
                  ? i[n]()
                  : "object" == typeof n && i._init(e(this));
            }),
            t
          );
        })();
      return (
        e(document).on("click", a.DATA_COLLAPSE, function (t) {
          t && t.preventDefault(), l._jQueryInterface.call(e(this), "toggle");
        }),
        e(document).on("click", a.DATA_REMOVE, function (t) {
          t && t.preventDefault(), l._jQueryInterface.call(e(this), "remove");
        }),
    ...
    l = (function (e) {
                  ...
                  function (t) {
                    this._settings.loadInContent &&
                      ("" != this._settings.sourceSelector &&
                        (t = e(t).find(this._settings.sourceSelector).html()),
      ...
      return (
        e(document).on("click", o.DATA_REFRESH, function (t) {
          t && t.preventDefault(), r._jQueryInterface.call(e(this), "load");
        }),
        (e.fn[t] = r._jQueryInterface),
        (e.fn[t].Constructor = r),
        (e.fn[t].noConflict = function () {
    ...
    c = (function (e) {
      var t = "Dropdown",
        ...
        a = (function () {
          ...
          return (
            (t.prototype.toggleSubmenu = function () {
            ...
            (t._jQueryInterface = function (n) {
              return this.each(function () {
                var i = e(this).data("lte.dropdown"),
                  s = e.extend({}, o, e(this).data());
                i || ((i = new t(e(this), s)), e(this).data("lte.dropdown", i)),
                  "toggleSubmenu" === n && i[n]();
              });
            }),
            t
